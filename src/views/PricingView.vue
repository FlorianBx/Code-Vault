	...
	<div>
		...
		<footer class="mt-24 sm:mt-56" aria-labelledby="footer-heading">
			...
			<div class="mx-auto max-w-7xl px-6 pb-8 lg:px-8">
				<div
					class="border-t border-white/10 pt-16 sm:pt-24 xl:grid xl:grid-cols-3 xl:gap-8"
				>
					...
					<div class="mt-10 xl:mt-0">
						...
						<form class="mt-6 sm:flex sm:max-w-md">
							...
							<div class="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
								<button
									type="submit"
									class="flex w-full items-center justify-center rounded-md bg-vue px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-secondary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
								>
									Subscribe
								</button>
							</div>
