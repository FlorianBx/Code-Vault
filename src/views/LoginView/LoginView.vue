        ...
        <div>
          <div class="relative mt-10">
            <div class="absolute inset-0 flex items-center" aria-hidden="true">
              <div class="w-full border-t border-ring" />
            </div>
            <div
          ...
          <div class="mt-6">
            <a
              href="#"
              class="flex w-full items-center justify-center gap-3 text-base rounded-md shadow-neumorphic bg-[#24292F] px-3 py-3 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#24292F]"
            >
              <svg
                class="h-5 w-5"
                aria-hidden="true"
